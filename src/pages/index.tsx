    ...
    <>
      ...
      <main className={styles.main}>
        <div className={styles.grid}>
          <a
            href="https://twitter.com/takokun778"
          ...
          <a
            href="https://github.com/takokun778"
            className={styles.card}
            target="_blank"
            rel="noopener noreferrer"
          >
